...
var MILSTDIcon = L.Icon.extend({ options: { iconSize: [60,60], iconAnchor: [30, 30], popupAnchor: [0, -33] } });
...
// Entity list
var entities = [
    new Entity(50.71605, -1.87557, "Home", "SFGPI-----H____", "<h3>Home Loc: Bournemouth</h3><p>Although I have lived in several places around Dorset and Hampshire, I grew up here in Bournemouth, where I now live with my family.</p><img src='./photos/bournemouth.jpg' class='photo'/>"),
    new Entity(50.74845, -1.85871, "Bournemouth School for Boys", "EFFPDB----H____", "<h3>Secondary Education:<br/>Bournemouth School for Boys</h3><p>I studied at Bournemouth School for Boys from 1995-2002. I achieved A-levels in Maths, Further Maths, Physics and Electronics, alongside 11 GCSEs and a Cambridge Language Certificate in Japanese & Japanese Studies.</p>"),
    new Entity(52.1019579,-2.0666612, "Pershore College", "EFFPDA----H____", "<h3>BTEC in Management</h3><p>As part of my Year in Industry at QinetiQ, I achieved a BTEC in Management from Pershore College.</p>"),
    new Entity(50.9356, -1.3963, "Southampton University", "EFFPDA----H____", "<h3>Degree:<br/>BSc (Hons) in Physics</h3><p>I studied Physics at Southampton University from 2003 to 2006, including modules in quantum physics, relativity, optronics, electronics and semiconductor design.</p>"),

    new Entity(50.60154, -2.45008, "QinetiQ", "EFFPCF----H____", "<h3>Worked at QinetiQ<br/>(2006-2009)</h3><p>During my time at QinetiQ I worked on a number of diverse projects, both military and commercial. You can see more details on many of them by clicking around the map. In addition to my full-time employment, I also did a Year in Industry placement at QinetiQ in 2002-2003, and worked there as a summer student in 2004 & 2005.</p>"),
    new Entity(50.70983, -2.43965, "[Current Employer]", "EFFPCF----H____", "<h3>Current Employer:<br/>Details Redacted</h3><p>Employer details available on request.</p><p>I have worked at my current employer in the Dorset area since 2009. I have worked on a number of major and minor projects at the company, and currently am employed as a Principal Software Engineer.</p>"),
    new Entity(51.1661,10.4469, "Parent Company (Germany)", "EFFPCF----H____", "<h3>Parent Company in Germany</h3><p>My employer's parent company is based in Germany. I have liaised with their autonomous vehicles and GUI design teams to improve mutual understanding and cooperation between the UK and German branches of the business.</p>"),
    new Entity(51.5099502,-0.121424, "IET", "SFGPI-----H____", "<h3>Member of the IET</h3><p>I have been a member of the Institution of Engineering and Technology since 2012, and am currently working towards Chartered Engineer status.</p>"),

    new Entity(26.2902,52.3166, "[Middle East Projects]", "SUSP------_____", "<h3>Middle East Projects</h3><p>I have worked with Middle East navies on a number of projects, and have spent time in several Gulf states to conduct testing and achieve acceptance of those systems.</p><img src='./photos/mideast.jpg' class='photo'/>"),
    new Entity(29.6,145.0, "[Far East Projects]", "SUSP------_____", "<h3>Far East Projects</h3><p>I have worked with customers in the Far East on mine countermeasures programmes.</p>"),
    new Entity(57.40034,-5.93245, "[Unmanned Warrior 2016]", "SFUPWMGX--_____", "<h3>Unmanned Warrior 2016</h3><p>As part of my employer's trials team, I attended the Navy's Unmanned Warrior 2016 trial and successfully demonstrated an unmanned minehunting system.</p><img src='./photos/skyebridge.jpg' class='photo'/>"),
    new Entity(53.0888813,8.8138321, "[UDT 2017]", "SFGPI-----H____", "<h3>UDT 2017</h3><p>I attended the UDT conference in Bremen, Germany in 2017 as a speaker, presenting a paper entitled 'Approaches to testing of COLREGs-Compliant Collision Avoidance for Unmanned Surface Vessels'.</p>"),
    new Entity(51.3624537,2.9851921, "[Belgium MCM Trials 2017]", "SFUPWMGX--_____", "<h3>Belgium MCM Trials 2017</h3><p>I was deputy trials officer and main mission planner / remote operator for our company during the Belgian Navy's maritime mine countermeasures trials in the North Sea in 2017. We successfully demonstrated an unmanned surface vessel with towed mine-hunting sonar and on-board remote mine disposal vehicles.</p><img src='./photos/belgium.jpg' class='photo'/>"),
    new Entity(55.9636233,-4.8482684, "[Clyde Hydrography Operations]", "SFSPCUM---_____", "<h3>Clyde Hydrography Operations</h3><p>I have worked with the Royal Navy to help improve hygrographic survey operations in UK waters.</p>"),
    new Entity(44.6545544,-63.5634948, "[Cold Weather Trials 2020]", "SFSPCUM---_____", "<h3>Cold Weather Trials 2020</h3><p>During 2020 I worked with the Royal Navy overseas on a human factors trial, investigating the effects of cold weather on the system and its operators.</p><img src='./photos/halifax.jpg' class='photo'/>"),

    new Entity(50.44, -2.3, "Unmanned Surface Vehicle", "SFSPCUM---_____", "<h3>Mine Countermeasures and Multi-role USVs</h3><p>My main domain experience is in unmanned surface vessels, with 10 years working on them in various forms. I am currently the lead software engineer for the company's Autonomy and Command & Control systems, working with internal and external customers to deliver unmanned vehicle systems to meet their needs. I currently provide technical leadership for a small team.</p>"),
    ...
    new Entity(50.633, -1.8, "Exercise Mine", "SFUPWMGX--_____", "<h3>Exercise Mine & Range Systems</h3><p>Whilst working for QinetiQ, I developed user interface software used for UK exercise mines and range systems for export.</p>"),
    new Entity(50.419, -1.649, "Submarine", "SFUPSN----_____", "<h3>Submarine Communications</h3><p>I have designed and developed user interface and embedded software used for secure data communications between submarines.</p><img src='./photos/sub.jpg' class='photo'/>"),
    new Entity(50.471, -1.530, "Submarine", "SFUPSN----_____", "<h3>Submarine Communications</h3><p>I have designed and developed user interface and embedded software used for secure data communications between submarines.</p><img src='./photos/sub.jpg' class='photo'/>"),
    new Entity(50.4689, -2.1547, "MILCO 3", "SHUPWMG---_____", "<h3>Mine Countermeasures</h3><p>I have domain expertise in a variety of MCM techniques, drawn from over a decade working on mine-hunting and mine-sweeping systems, both for unmanned vehicles and larger ships.</p><img src='./photos/mine.jpg' class='photo'/>"),
    new Entity(50.4278, -2.4582, "MILCO 2 [N]", "SHUPWMGO--_____", "<h3>Mine Countermeasures</h3><p>I have domain expertise in a variety of MCM techniques, drawn from over a decade working on mine-hunting and mine-sweeping systems, both for unmanned vehicles and larger ships.</p><img src='./photos/undex.jpg' class='photo'/>"),
    new Entity(50.3849, -2.7438, "MILCO 1 [N]", "SHUPWMGO--_____", "<h3>Mine Countermeasures</h3><p>I have domain expertise in a variety of MCM techniques, drawn from over a decade working on mine-hunting and mine-sweeping systems, both for unmanned vehicles and larger ships.</p><img src='./photos/undex.jpg' class='photo'/>"),
...
var arrow = L.polyline([[50.44, -2.3], [50.47, -2.25]], {color: 'red'}).addTo(map);
